          ...
          <div className="animate-fade-in-up">
            <div className="text-center mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-orbitron font-black mb-4">
                <span className="gradient-text">NOME DA EMPRESA</span>
              </h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-4">
                <div>
                  <label htmlFor="nomeEmpresa" className="block text-lg font-medium text-gray-300 mb-2">
                    Nome Fantasia
                  </label>
                  <input
                    type="text"
                ...
                {nomeEmpresa && (
                  <div className="bg-slate-800/30 backdrop-blur-sm border border-cyan-500/20 rounded-xl p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-gray-400 text-sm">Nome fantasia informado</p>
                        <p className="text-white font-semibold">{nomeEmpresa}</p>
                      </div>
                    </div>
                  </div>
                )}
              ...
              <div className="bg-cyan-500/10 border border-cyan-500/30 rounded-xl p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-white font-semibold mb-1">Diferença entre Razão Social e Nome Fantasia</h4>
                    ...
                    <div className="bg-slate-800/50 rounded-lg p-3 mt-3">
                      ...
                      <p className="text-gray-300 text-sm">
                        <span className="text-white">Razão Social:</span> {localStorage.getItem('cadastroRazaoSocial') || 'Empresa Ltda.'}<br />
                        <span className="text-white">Nome Fantasia:</span> {nomeEmpresa || 'Nome Popular'}
                      </p>
                    </div>
                  </div>
                </div>
