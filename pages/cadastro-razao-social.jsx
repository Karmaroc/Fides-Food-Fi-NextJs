      ...
      <div className="fixed left-6 top-1/2 transform -translate-y-1/2 z-40">
        <div className="flex flex-col items-center gap-4">
          <div className="bg-gray-100 backdrop-blur-sm border border-gray-200 rounded-full w-2 h-48 relative">
            <div className="bg-gradient-to-b from-orange-500 to-orange-600 w-2 rounded-full absolute top-0 left-0" style={{ height: '50%' }}></div>
          </div>
          ...
          <div className="animate-fade-in-up">
            <div className="text-center mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-orbitron font-black mb-4">
                <span className="brand-gradient">RAZÃO SOCIAL</span>
              </h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-4">
                <div>
                  <label htmlFor="razaoSocial" className="block text-lg font-medium text-gray-700 mb-2">
                    Razão Social
                  </label>
                  <input
                    type="text"
                ...
                {razaoSocial && (
                  <div className="bg-gray-50 border border-gray-100 rounded-xl p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-gray-500 text-sm">Nome informado</p>
                        <p className="text-gray-900 font-semibold">{razaoSocial}</p>
                      </div>
                    </div>
                  </div>
                )}
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-xl p-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="text-blue-900 font-semibold mb-1">O que é Razão Social?</h4>
                    ...
                    <div className="bg-white/50 rounded-lg p-3 mt-3 border border-blue-100">
                      ...
                      <p className="text-blue-800 text-sm">
                        <span className="font-semibold text-blue-900">Razão Social:</span> FidesFoodFi Tecnologia Ltda.<br />
                        <span className="font-semibold text-blue-900">Nome Fantasia:</span> FidesFoodFi
                      </p>
                    </div>
                  </div>
                </div>
