  ...
  return (
    <div className="bg-white text-gray-900 font-sans overflow-x-hidden min-h-screen">
      ...
      <div className="min-h-screen flex flex-col lg:flex-row">
        {/* Left Side */}
        <div className="lg:w-1/2 relative flex items-center justify-center bg-slate-900 p-12 overflow-hidden min-h-[40vh] lg:min-h-screen">
        ...
        {/* Right Side */}
        <section className="lg:w-1/2 relative flex flex-col justify-center bg-white px-6 py-20 overflow-y-auto min-h-screen hero-gradient">
          <div className="max-w-xl mx-auto w-full animate-fade-in-up">
            <div className="text-center lg:text-left mb-12">
              <h1 className="text-4xl md:text-5xl font-orbitron font-black mb-4">
                <span className="brand-gradient uppercase">Seu Telefone</span>
              </h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-4 font-rajdhani">
                ...
                <div>
                  <label className="block text-lg font-medium text-gray-700 mb-2">Confirmar Telefone</label>
                  <input
                    type="tel"
              ...
              <div className="pt-6 font-orbitron">
                <button
                  ...
                  className="w-full px-8 py-5 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-2xl text-xl font-bold hover:shadow-2xl hover:shadow-orange-500/50 transition-all transform hover:scale-[1.02] disabled:opacity-50 flex items-center justify-center gap-3 shadow-lg"
                >
      ...
      <div className="fixed left-6 top-1/2 transform -translate-y-1/2 z-40">
        <div className="flex flex-col items-center gap-4">
          <div className="bg-gray-100 border border-gray-200 rounded-full w-2 h-48 relative overflow-hidden">
            <div className="bg-gradient-to-b from-orange-500 to-orange-600 w-full h-full rounded-full transition-all duration-1000"></div>
          </div>
          <p className="text-[10px] text-gray-500 font-medium font-orbitron uppercase">6/6</p>
        </div>
      </div>
    </div>
  );
