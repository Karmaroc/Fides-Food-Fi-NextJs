...
export default function CadastroDataNascimento() {
  ...
  useEffect(() => {
    ...
    if (!nome || !sobrenome || !tipoPessoa || !rg || tipoPessoa !== 'pf') {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (dataNascimento) {
      localStorage.setItem('cadastroDataNascimento', dataNascimento);
      ...
      <div className="fixed left-6 top-1/2 transform -translate-y-1/2 z-40">
        <div className="flex flex-col items-center gap-4">
          <div className="bg-slate-800/50 backdrop-blur-sm border border-cyan-500/20 rounded-full w-2 h-48 relative">
            <div className="bg-gradient-to-b from-cyan-500 to-emerald-500 w-2 rounded-full absolute top-0 left-0" style={{ height: '66.66%' }}></div>
          </div>
          <div className="text-center">
            <div className="text-xs text-gray-400 font-medium">Passo 4 de 6</div>
          </div>
        </div>
      </div>
          ...
          <div className="animate-fade-in-up">
            <div className="text-center mb-12">
              ...
              <h1 className="text-4xl md:text-5xl font-orbitron font-black mb-4">
                <span className="gradient-text">DATA DE NASCIMENTO</span>
              </h1>
              <p className="text-xl text-gray-300 font-light">
                Precisamos saber sua idade para oferecer as melhores condições
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-4">
                <div>
                  <label htmlFor="dataNascimento" className="block text-lg font-medium text-gray-300 mb-2">
                    Data de Nascimento
                  </label>
                  <input
                    type="date"
                  ...
                  <div className="bg-slate-800/30 backdrop-blur-sm border border-cyan-500/20 rounded-xl p-4">
                    ...
                    {!isValidAge(dataNascimento) && (
                      <p className="text-red-400 text-sm mt-2">
                        {calculateAge(dataNascimento) < 18 
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm leading-relaxed">
                      Sua data de nascimento é usada apenas para verificação de idade e não será compartilhada. 
                      O uso do FidesFoodFi é permitido apenas para maiores de 18 anos.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6">
                <button
                  type="submit"
                  disabled={!dataNascimento || !isValidAge(dataNascimento)}
