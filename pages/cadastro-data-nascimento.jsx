  ...
  return (
    <div className="bg-white text-gray-900 font-sans overflow-x-hidden min-h-screen">
      ...
      <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-40">
        <div className="flex items-center gap-4">
          <div className="bg-gray-100 backdrop-blur-sm border border-gray-200 rounded-full h-2 w-48 relative">
            <div className="bg-gradient-to-r from-orange-500 to-orange-600 h-2 rounded-full absolute top-0 left-0" style={{ width: '66.66%' }}></div>
          </div>
      ...
      <div className="min-h-screen flex flex-col lg:flex-row pt-20">
        {/* Left Side - Text with brand-gradient */}
            ...
            <div className="animate-fade-in-up">
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-4">
                  <div>
                    <label htmlFor="dataNascimento" className="block text-lg font-medium text-gray-700 mb-2">
                      Data de Nascimento
                    </label>
                    <input
                      type="text"
                  ...
                  {dataNascimento && (
                    <div className="bg-gray-50 border border-gray-100 rounded-xl p-4 shadow-sm">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-gray-500 text-sm">Idade calculada</p>
                          <p className="text-2xl font-orbitron font-bold text-gray-900">
