...
export default function CadastroDataNascimento() {
  ...
  useEffect(() => {
    ...
    if (!apelidoSalvo || !tipoPessoa || !rg || tipoPessoa !== 'pf') {
  ...
  return (
    <div className="bg-slate-950 text-white font-sans overflow-x-hidden min-h-screen">
      ...
      <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-40">
        <div className="flex items-center gap-4">
          <div className="bg-slate-800/50 backdrop-blur-sm border border-cyan-500/20 rounded-full h-2 w-48 relative">
            <div className="bg-gradient-to-r from-cyan-500 to-emerald-500 h-2 rounded-full absolute top-0 left-0" style={{ width: '66.66%' }}></div>
          </div>
      ...
      <div className="min-h-screen flex flex-col lg:flex-row pt-20">
        {/* Left Side - Text with Inverted Gradient (Green to Blue) */}
          ...
          <div className="relative z-10 max-w-xl">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-orbitron font-black leading-tight">
              <span className="bg-gradient-to-r from-emerald-400 via-cyan-400 to-blue-500 bg-clip-text text-transparent">
                Para usar o método precisa ter pelo menos 18 anos. Ok, {apelido}?
              </span>
            </h1>
          </div>
        </div>
                  ...
                  {dataNascimento && (
                    <div className="bg-slate-800/30 backdrop-blur-sm border border-cyan-500/20 rounded-xl p-4">
                      <div className="flex items-center justify-between">
                        ...
                        <div className={`w-12 h-12 rounded-full flex items-center justify-center ${isValidAge(dataNascimento)
